...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="tip">添加设备</div>
        ...
        <tr>
            <td style="width: 10%; text-align: center;">网卡</td>
            <td style="width: 80%;">&nbsp;&nbsp;
    ...
    <div style="margin-top: 10px; text-align:center;">
        <asp:Button ID="ImageButtonsave" runat="server" Text="添加"  OnClick="ImageButtonsave_Click"/>
        <asp:Button ID="Buttoncontinue" runat="server" Text="保存并继续添加" OnClick="Buttoncontinue_Click" />
    </div>
</asp:Content>
